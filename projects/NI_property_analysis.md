...
1. [Data Cleanup](NI_property_analysis_cleanup.md)
...
2. [Initial Exploration](NI_property_analysis_initial_exploration.md)

	Diving into the cleaned data to see if there are any interesting discoveries near the surface.

3. [Joining new Data](NI_property_analysis_joining_data.md)
...
4. [Coming soon!](NI_property_analysis.md)
